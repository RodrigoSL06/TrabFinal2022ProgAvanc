...
class SecondFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var adapterLocalidade : AdapterLocalidade? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerViewLocalidade.layoutManager = LinearLayoutManager(requireContext())
    ...
    override fun onCreateLoader(id: Int, args: Bundle?): Loader<Cursor> =
        CursorLoader(
            requireContext(),
            ContentProviderFutsal.ENDERECO_LOCALIDADE,
            TabelaBDLocalidade.TODAS_COLUNAS,
            null,
            null,
            "${TabelaBDLocalidade.CAMPO_NOME}"
        )
